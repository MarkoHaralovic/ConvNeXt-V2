...
#model parameters
MODEL="<model>"
INPUT_SIZE=<INPUT_SIZE> #IN1K -> 224
DROP_PATH=0.0
LAYER_DECAY_TYPE='single' 

#dataset parameters
DATA_PATH="<PATH_TO_DATASET>"
NB_CLASSES=<NB_OF_CLASSES> # IN1K -> 1000
...
DEVICE="<DEVICE>" #"cuda"
SEED=0
RESUME='' # PATH TO THE MODEL WEIGHTS, OF THE MODEL WHICH WILL BE EVALUATED

IMAGENET_DEFAULT_MEAN_AND_STD=True
DATA_SET='<DATASET_NAME>' # IN1K -> IMAGENET1K
EVAL=True
